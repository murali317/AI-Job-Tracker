...
const JobCard = ({ job, onDelete, onStatusChange, onJobUpdated }: JobCardProps) => {
  ...
  return (
    <div className={`group bg-white dark:bg-gray-800 rounded-xl border-l-4 ${cfg.border} border border-gray-200/70 dark:border-gray-700 p-4 shadow-sm hover:shadow-md dark:shadow-none dark:hover:shadow-none ring-1 ring-gray-100 dark:ring-0 transition-shadow`}>
      {/* Header */}
      <div className="flex items-start gap-3 mb-3">
        ...
        <div className="flex items-center gap-0.5">
          <button
            ...
            title="Edit"
            className="opacity-0 group-hover:opacity-100 p-1 rounded text-gray-300 hover:text-indigo-500 dark:text-gray-500 dark:hover:text-indigo-400 transition-all"
          >
      ...
      <div className="mb-3">
        ...
        >
          <option value="saved" className="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100">Saved</option>
          <option value="applied" className="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100">Applied</option>
          <option value="interviewing" className="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100">Interviewing</option>
          <option value="offered" className="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100">Offered</option>
      ...
      {showEditModal && (
        <EditJobModal
          ...
          onJobUpdated={(updated) => { onJobUpdated(updated); setShowEditModal(false); }}
        />
      )}
    </div>
  );
